...
def sample_input_variables() -> Dict[str, TravelAdviceInput]:
    return {
        ...
        "description": TravelAdviceInput(name='description', 
                                         html_section='metadata'),
        "test_message": TravelAdviceInput(name='test_message', 
...
def test_get_required_prompt_field_page_content(sample_doc):
    input_var = TravelAdviceInput(name="test_message", html_section="page_content", 
                                  html_section_start="Test Message", 
                                  html_section_end="End Test", 
...
def test_get_required_prompt_fields(mock_input_variables, sample_input_variables, sample_doc):
    query = "Good to go?"
...
# Additional tests can be added for construct_doc2advice_chain and construct_query2advice_chain
